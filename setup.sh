...
function LOGO() {
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$GRAY https://t.me/TazVPN$NC     │
    └───────────────────────────────────────────────┘
...
clear
      ...
      echo -e ""
      echo -e "\e[93m Telegram\e[32;1m : https://t.me/Tazpin"
      echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | lolcat
      echo -e ""
      exit 0
    fi
...
#####core
cd /usr/local/bin
wget https://raw.githubusercontent.com/SETANTAZVPN/mlbb/main/ws.zip
unzip ws.zip
chmod +x *
rm -fr ws.zip
###slowdns
mkdir /etc/slowdns
cd /etc/slowdns
wget https://raw.githubusercontent.com/SETANTAZVPN/mlbb/main/dns.zip
unzip dns.zip
chmod +x *
...
wget -O /etc/pam.d/common-password "https://github.com/SETANTAZVPN/last/raw/main/password"
...
wget -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/SETANTAZVPN/last/main/nginx.conf
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/SETANTAZVPN/mlbb/main/funnvpn.conf
...
<font color="red"><b>********  SETANTAZVPN  ********</b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
...
wget -O /etc/xray/config.json https://raw.githubusercontent.com/SETANTAZVPN/mlbb/main/config.json
